...
namespace ExamenDistancia
{
  public class frmForma1 : Form
  {
    ...
    private void Form1_Load(object sender, EventArgs e)
    {
      ...
      this.dgSinDerecho.Rows.Add((object) "21100196", (object) "No acumuló el 80 % de asistencia en este parcial");
      this.dgSinDerecho.Rows.Add((object) "20100221", (object) "No acumuló el 80 % de asistencia en este parcial");
      this.dgSinDerecho.Rows.Add((object) "21100247", (object) "No acumuló el 80 % de asistencia en este parcial");
      this.dgSinDerecho.Rows.Add((object) "21100296", (object) "No acumuló el 80 % de asistencia en este parcial");
      this.dgSinDerecho.Rows.Add((object) "21100777", (object) "No acumuló el 80 % de asistencia en este parcial");
      this.dgSinDerecho.Rows.Add((object) "21100154", (object) "No acumuló el 80 % de asistencia en este parcial");
      ...
      this.dgSinDerecho.Rows.Add((object) "20100230", (object) "No acumuló el 80 % de asistencia en este parcial");
      ...
      this.dgSinDerecho.Rows.Add((object) "21100290", (object) "No acumuló el 80 % de asistencia en este parcial");
      ...
      // Mostrar resultados
      DatosExamen miListaExamenes = new DatosExamen();
      Console.WriteLine($"\n CANTIDAD DE EJERCICIOS: {miListaExamenes.miListaExamenes.Count} \n\n");
      foreach (var ejercicio in miListaExamenes.miListaExamenes)
      { 
          //Console.WriteLine(this.Decodificar(ejercicio.Clave));
          Console.WriteLine(this.Decodificar(ejercicio.Redaccion) + "\n\n");
          //Console.WriteLine(this.Decodificar(ejercicio.Inciso) + "\n\n");
      }
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.lstEstudiantesNOpresentan.Items.AddRange(new object[19]
      {
        (object) "21100777",
        (object) "21100154",
        (object) "21100160",
      ...
      this.lstEstudiantesED.Items.AddRange(new object[17]
      {
        (object) "19100139",
        (object) "20100163",
        (object) "19100144",
      ...
      this.lstEstudiantesFP.Items.AddRange(new object[12]
      {
        (object) "21100170",
        (object) "21100191",
        (object) "21100198",
