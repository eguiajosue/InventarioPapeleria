...
namespace ExamenDistancia
{
  public class frmForma1 : Form
  {
    ...
    private static bool blnAdministrador = false;
    ...
    private void CrearFormaLogin()
    {
      ...
      if (form.ShowDialog() == DialogResult.OK)
      {
        try
        {
          ...
          //  throw new Exception("Aún no es hora de iniciar el examen\n\nHora de su equipo de cómputo: " + DateTime.Now.ToShortTimeString());
    ...
    {
        this.Text = "Examen a distancia Por Ing. Bruno López Takeyas - " + this.misDatosExamen.NombreMateria + " - " +
                    this.misDatosExamen.TipoExamen + " - " + this.misDatosExamen.TemaExamen + " - " +
                    this.misDatosExamen.FechaInicio.ToLongDateString();
    ...
    private void InitializeComponent()
    {
      ...
      this.lstEstudiantesNOpresentan.Items.AddRange(new object[20]
      {
        (object) "21100777",
        (object) "21100154",
        (object) "21100160",
